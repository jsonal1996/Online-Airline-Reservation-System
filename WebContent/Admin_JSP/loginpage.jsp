...
<ul>
	<li><a style="color:black ;font-weight:bold" href="register.jsp">Register</a></li>
...
<div style="
   ...
   font-family:arial;">		
			<form style="margin-right: 150px;align:center;font-size: 14px;margin-top: 110px;color: #000000;" method="post" action="validate1">
				...
				<input type="radio" name="type" value="User" required>User<br>
				 ...
				 <input  type="submit" name="password" value="Log in" > 
			 </form>
</div>		
</body>
</html>
